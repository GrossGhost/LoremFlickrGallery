...
public class MainMVPActivity extends MvpAppCompatActivity implements MainView {
    ...
    private void onImageClick(LoremFlickrImage image, int position, View view) {
        ...
        Intent intent = DetailsActivity.newInstance(MainMVPActivity.this, image.getImage(), presenter.getCurrentTag(), image.getLock());

        ActivityOptions options = ActivityOptions
                .makeSceneTransitionAnimation(MainMVPActivity.this, view, getResources().getString(R.string.image_transition));
